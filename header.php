...
<html <?php language_attributes(); ?>>
  ...
  <body <?php body_class(); ?>>
    ...
    <div class="container">
      <h1 class="school-logo-text float-left"><a href="<?php echo site_url() ?>"><strong>Sydney</strong> University</a></h1>
      ...
      <div class="site-header__menu group">
        <nav class="main-navigation">
          <ul class="min-list group">
            ...
            <li <?php if(get_post_type() == 'program') print 'class="current-menu-item"' ?>><a href="<?php print get_post_type_archive_link('program') ?>">Programs</a></li>
            ...
            <li <?php if(get_post_type() == 'campus') print 'class="current-menu-item"' ?>><a href="<?php print get_post_type_archive_link('campus'); ?>">Campuses</a></li>
