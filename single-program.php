    ...
    <div class="container container--narrow page-section">
      ...
      <?php 
        ...
        if($relatedProfessors->have_posts()) :
            print '<hr class="section-break">';
            print '<h2 class="headline headline--medium">'.get_the_title().' Professors</h2>';
            print '<ul class="professor-cards"';
            ...
            if($homepageEvents->have_posts()) :
                print '<hr class="section-break">';
                print '<h2 class="headline headline--medium">Upcoming '.get_the_title().' Events</h2>';
